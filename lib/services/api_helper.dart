...
class ApiHelper {
  ...
  static String getApiKey() {
    print('${dotenv.env['apiKey1']} hgfhgfhg');
    return dotenv.env['apiKey1'] ?? '';
  }

  //! Build urls
  static String _constructWeatherUrl() =>
      '$baseUrl/weather?lat=$lat&lon=$lon&units=metric&appid=${getApiKey()}';

  static String _constructForecastUrl() =>
      '$baseUrl/forecast?lat=$lat&lon=$lon&units=metric&appid=${getApiKey()}';

  static String _constructWeatherByCityUrl(String cityName) =>
      '$baseUrl/weather?q=$cityName&units=metric&appid=${getApiKey()}';
